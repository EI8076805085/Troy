...
public class PrivacyPolicies extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Helper.INSTANCE.isNetworkAvailable(PrivacyPolicies.this)){
            submit();
        } else {
            Helper.INSTANCE.Error(PrivacyPolicies.this, getString(R.string.NOCONN));
        }
    ...
    public void submit() {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(PrivacyPolicies.this);
        JsonObjectRequest stringRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    String pp_image = obj.getString("pp_image");
                    ...
                    e.printStackTrace();
                    Toast.makeText(PrivacyPolicies.this, "" + e, Toast.LENGTH_SHORT).show();
                }
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(PrivacyPolicies.this, "" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
